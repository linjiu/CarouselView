...
@interface CarouselSV () <UIScrollViewDelegate>
...
- (id)initWithFrame:(CGRect)frame animationDuration:(NSTimeInterval)animationDuration
{
    ...
    if (animationDuration > 0.0) {
        self.animationTimer =
        [NSTimer scheduledTimerWithTimeInterval:(self.animationDuration = animationDuration)
                                         target:self
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _page = [[UIPageControl alloc]initWithFrame:(CGRectMake(60, 370, 200, 20))];
